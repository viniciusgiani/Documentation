...
public class CategoriesApiController implements CategoriesApi {
    ...
    public ResponseEntity<List<Category>> getCategories(@Min(100) @Max(1000) @Parameter(in = ParameterIn.QUERY, description = "" ,schema=@Schema(allowableValues={ "100", "1000" }, minimum="100", maximum="1000"
    ...
    public ResponseEntity<Category> getCategoryDetails(@Min(100) @Max(1000) @Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema(allowableValues={ "100", "1000" }, minimum="100", maximum="1000"
